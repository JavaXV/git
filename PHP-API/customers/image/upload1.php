...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    	...
    	$que1=mysqli_query($conn,"SELECT * FROM `Guarantor` WHERE phoneno = '$smsalert'");
    ...
    if(move_uploaded_file($_FILES['file']['tmp_name'],$target_file)){
        ...
        $sql = "UPDATE Guarantor SET image='$filename', logo='$filename1' WHERE phoneno='$smsalert'";
